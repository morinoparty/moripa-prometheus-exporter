...
export function SearchToggle({ hideIfDisabled, size = "icon-sm", variant = "ghost", ...props }: SearchToggleProps) {
    ...
    return (
        ...
        >
            ...
            <div className="ms-auto inline-flex gap-0.5">
                {hotKey.map((k, i) => (
                    <kbd key={`hotkey-${i}`} className="rounded-md border bg-fd-background px-1.5">
                        {k.display}
                    </kbd>
                ))}
            </div>
